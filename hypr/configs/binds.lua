...
hl.bind(mainMod .. " + code:61",     hl.dsp.exec_cmd(rofi_scripts .. "/keybindings/keybindings"))
...
hl.bind("code:148",                  hl.dsp.exec_cmd(apps.launcher))
...
hl.bind(mainMod .. " + SHIFT + 5", hl.dsp.window.move({ workspace = "r~5" }))
hl.bind(mainMod .. " + SHIFT + 6", hl.dsp.window.move({ workspace = "r~6" }))
hl.bind(mainMod .. " + SHIFT + 7", hl.dsp.window.move({ workspace = "r~7" }))
hl.bind(mainMod .. " + SHIFT + 8", hl.dsp.window.move({ workspace = "r~8" }))
hl.bind(mainMod .. " + SHIFT + 9", hl.dsp.window.move({ workspace = "r~9" }))
...
hl.bind(mainMod .. " + CTRL + KP_Add",       hl.dsp.exec_cmd("playerctl next"))
hl.bind(mainMod .. " + CTRL + KP_Subtract",  hl.dsp.exec_cmd("playerctl previous"))
hl.bind(mainMod .. " + KP_Add",              hl.dsp.exec_cmd("pamixer -i 5"))
hl.bind(mainMod .. " + KP_Subtract",         hl.dsp.exec_cmd("pamixer -d 5"))
hl.bind(mainMod .. " + SHIFT + KP_Add",      hl.dsp.exec_cmd("pamixer --default-source -i 5"))
hl.bind(mainMod .. " + SHIFT + KP_Subtract", hl.dsp.exec_cmd("pamixer --default-source -d 5"))
